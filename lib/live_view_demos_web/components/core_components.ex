defmodule LiveViewDemosWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(LiveViewDemosWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(LiveViewDemosWeb.Gettext, "errors", msg, opts)
    end
  end
